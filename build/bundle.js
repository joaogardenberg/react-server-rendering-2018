      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 4:
            ...
            return _context.abrupt('return', res.redirect(303, context.url));
...
var Header = function Header(_ref) {
  ...
  var adminsButton = auth ? _react2.default.createElement(
    'li',
    null,
    _react2.default.createElement(
  ...
  _createClass(UsersListPage, [{
    ...
    value: function renderHead() {
      return _react2.default.createElement(
        ...
        _react2.default.createElement('meta', { property: 'og:title', content: this.props.users.length + ' users loaded' })
      );
    }
  }, {
    key: 'renderUsers',
...
UsersListPage = (0, _reactRedux.connect)(mapStateToProps, { fetchUsers: _actions.fetchUsers })(UsersListPage);
...
AdminsListPage = (0, _requireAuth2.default)(AdminsListPage);

AdminsListPage = (0, _reactRedux.connect)(mapStateToProps, { fetchAdmins: _actions.fetchAdmins })(AdminsListPage);
